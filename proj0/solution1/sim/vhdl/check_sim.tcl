...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.jet_hw.autotvin_jet_pt_0_V.dat"
         "c.jet_hw.autotvin_jet_pt_1_V.dat"
         "c.jet_hw.autotvin_jet_pt_2_V.dat"
         "c.jet_hw.autotvin_jet_pt_3_V.dat"
         "c.jet_hw.autotvin_jet_pt_4_V.dat"
         "c.jet_hw.autotvin_jet_pt_5_V.dat"
         "c.jet_hw.autotvin_jet_pt_6_V.dat"
         "c.jet_hw.autotvin_jet_pt_7_V.dat"
         "c.jet_hw.autotvin_jet_pt_8_V.dat"
         "c.jet_hw.autotvin_jet_pt_9_V.dat"
         "c.jet_hw.autotvin_jet_phi_0_V.dat"
         "c.jet_hw.autotvin_jet_phi_1_V.dat"
         "c.jet_hw.autotvin_jet_phi_2_V.dat"
         "c.jet_hw.autotvin_jet_phi_3_V.dat"
         "c.jet_hw.autotvin_jet_phi_4_V.dat"
         "c.jet_hw.autotvin_jet_phi_5_V.dat"
         "c.jet_hw.autotvin_jet_phi_6_V.dat"
         "c.jet_hw.autotvin_jet_phi_7_V.dat"
         "c.jet_hw.autotvin_jet_phi_8_V.dat"
         "c.jet_hw.autotvin_jet_phi_9_V.dat"
         "c.jet_hw.autotvout_met_pt2_V.dat"
         "c.jet_hw.autotvout_met_phi_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.jet_hw.autotvout_met_pt2_V.dat"
         "rtl.jet_hw.autotvout_met_phi_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
