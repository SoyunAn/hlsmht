...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /data1/scratch/syan/HLS_2019_2/Vivado/2019.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data1/scratch/syan/HLS_2019_2/Vivado/2019.1/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data1/scratch/syan/HLS_2019_2/Vivado/2019.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data1/scratch/syan/HLS_2019_2/Vivado/2019.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data1/scratch/syan/HLS_2019_2/Vivado/2019.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "jet_hw.autotvin.dat"
	set constFileTvOut       "jet_hw.autotvout.dat"
	set constFileHdlTvIn     "jet_hw.autohdltvin.dat"
	set constFileHdlTvOut    "jet_hw.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
